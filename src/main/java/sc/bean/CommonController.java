...
import sc.enums.ComponentSetType;
import sc.enums.ComponentSex;
import sc.enums.DataCompletionStrategy;
import sc.enums.DataModificationStrategy;
import sc.enums.DataPopulationStrategy;
import sc.enums.ItemArrangementStrategy;
import sc.enums.Month;
import sc.enums.PanelType;
import sc.enums.Quarter;
import sc.enums.QueryCriteriaMatchType;
import sc.enums.QueryDataType;
...
import sc.enums.QueryVariableEvaluationType;
...
public class CommonController implements Serializable {
    ...
    public Map<Long, Product> arrayToMap(List<Product> lst){
        HashMap<Long, Product> m = new HashMap<>();
        for(Product s:lst){
            m.put(s.getId(), s);
        }
        return m;
    ...
    public List<Product> commonItems(List<Product> lst1, List<Product> lst2){
        HashMap<Long, Product> m = new HashMap<>();
        for(Product s1:lst1){
        ...
        List<Product> sols = new ArrayList<>();
