...
import sc.facade.ClientEncounterComponentFormSetFacade;
...
import sc.enums.ComponentSex;
import sc.enums.DataCompletionStrategy;
import sc.enums.DataPopulationStrategy;
...
// <editor-fold defaultstate="collapsed" desc="EJBs">
    ...
    @EJB
    private sc.facade.ClientEncounterComponentFormSetFacade ejbFacade;
    @EJB
...
//    }
    ...
    public List<SiFormSet> fillEncountersFormSets(Product c, String type) {
        EncounterType ec = null;
        try {
            ec = EncounterType.valueOf(type);
    ...
    public List<SiFormSet> fillEncountersFormSets(Product c, EncounterType type) {
        return ClientEncounterComponentFormSetController.this.fillEncountersFormSets(c, type, 0);
    }

    public List<SiFormSet> fillEncountersFormSets(Product c, EncounterType type, int count) {
        return ClientEncounterComponentFormSetController.this.fillEncountersFormSets(c, type, count, true);
    }

    public List<SiFormSet> fillEncountersFormSets(Product c, String type, int count) {
        EncounterType ec = null;
        try {
            ec = EncounterType.valueOf(type);
    ...
    public List<SiFormSet> fillEncountersFormSets(Product c, EncounterType type, int count, Boolean completeOnly) {
        // //System.out.println("fillEncountersFormSetsForSysadmin");
        // //System.out.println("count = " + count);
    ...
    public SiFormSet findLastUncompletedEncounterOfThatType(DesignComponentFormSet dfs, Product c, Institution i, EncounterType t) {
...
//                + " order by f.id desc";
    ...
    public SiComponentItem fillClientValue(Product c, String code) {
        if (c == null || code == null) {
            return null;
        }
    ...
    public List<SiComponentItem> fillClientValues(Product c, String code) {
    ...
    public List<SiComponentItem> updateFromClientValueMultiple(SiComponentItem ti, Product c) {
    ...
    public void updateFromClientValueSingle(SiComponentItem ti, Product c, Map<String, SiComponentItem> cvs) {
...
//        }
    ...
    public sc.facade.ClientEncounterComponentFormSetFacade getEjbFacade() {
        return ejbFacade;
    }
