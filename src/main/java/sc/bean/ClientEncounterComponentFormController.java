...
import sc.facade.ClientEncounterComponentFormFacade;
...
public class ClientEncounterComponentFormController implements Serializable {
    ...
    @EJB
    private sc.facade.ClientEncounterComponentFormFacade ejbFacade;
    ...
    public sc.facade.ClientEncounterComponentFormFacade getEjbFacade() {
        return ejbFacade;
    }
